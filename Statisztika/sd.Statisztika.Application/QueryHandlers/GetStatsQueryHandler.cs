...
public class GetStatsQueryHandler(StatisticsContext context, ILogger<GetStatsQueryHandler> logger) : IRequestHandler<GetStatsQuery, GetStatsViewModel>
{
    private readonly StatisticsContext _context = context;
    private readonly ILogger<GetStatsQueryHandler> _logger = logger;
