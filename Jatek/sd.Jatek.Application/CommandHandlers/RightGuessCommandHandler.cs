...
public class RightGuessCommandHandler(GameContext context, ILogger<RightGuessCommandHandler> logger)
    : IRequestHandler<RightGuessCommand, Unit>
{
    private readonly GameContext _context = context;
    private readonly ILogger<RightGuessCommandHandler> _logger = logger;
