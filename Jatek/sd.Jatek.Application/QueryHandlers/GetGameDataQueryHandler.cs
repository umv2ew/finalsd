...
public class GetGameDataQueryHandler(GameContext context, ILogger<GetGameDataQueryHandler> logger)
    : IRequestHandler<GetGameDataQuery, GameDataViewModel>
{
    private readonly GameContext _context = context;
    private readonly ILogger<GetGameDataQueryHandler> _logger = logger;
